...
type ExpectedCreateIndex struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, arg1 string, arg2 interface{}) error
	arg0     string
	arg1     string
	arg2     interface{}
}
...
type ExpectedDeleteAttachment struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, arg1 string, arg2 string, options map[string]interface{}) (string, error)
	arg0     string
	arg1     string
	arg2     string
	ret0     string
...
type ExpectedDeleteIndex struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, arg1 string) error
	arg0     string
	arg1     string
}
...
type ExpectedGetMeta struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, options map[string]interface{}) (int64, string, error)
	arg0     string
	ret0     int64
	ret1     string
}
...
type ExpectedAllDocs struct {
	commonExpectation
	callback func(ctx context.Context, options map[string]interface{}) (*Rows, error)
	ret0     *Rows
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedAllDocs) WillExecute(cb func(ctx context.Context, options map[string]interface{}) (*Rows, error)) *ExpectedAllDocs {
	e.callback = cb
	return e
}
...
type ExpectedBulkDocs struct {
	commonExpectation
	callback func(ctx context.Context, arg0 []interface{}, options map[string]interface{}) (*BulkResults, error)
	arg0     []interface{}
	ret0     *BulkResults
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedBulkDocs) WillExecute(cb func(ctx context.Context, arg0 []interface{}, options map[string]interface{}) (*BulkResults, error)) *ExpectedBulkDocs {
	e.callback = cb
	return e
}
...
type ExpectedBulkGet struct {
	commonExpectation
	callback func(ctx context.Context, arg0 []driver.BulkGetReference, options map[string]interface{}) (*Rows, error)
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedBulkGet) WillExecute(cb func(ctx context.Context, arg0 []driver.BulkGetReference, options map[string]interface{}) (*Rows, error)) *ExpectedBulkGet {
	e.callback = cb
	return e
}
...
type ExpectedChanges struct {
	commonExpectation
	callback func(ctx context.Context, options map[string]interface{}) (*Changes, error)
	ret0     *Changes
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedChanges) WillExecute(cb func(ctx context.Context, options map[string]interface{}) (*Changes, error)) *ExpectedChanges {
	e.callback = cb
	return e
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedDesignDocs) WillExecute(cb func(ctx context.Context, options map[string]interface{}) (*Rows, error)) *ExpectedDesignDocs {
	e.callback = cb
	return e
}
...
type ExpectedExplain struct {
	commonExpectation
	callback func(ctx context.Context, arg0 interface{}) (*driver.QueryPlan, error)
	arg0     interface{}
...
type ExpectedFind struct {
	commonExpectation
	callback func(ctx context.Context, arg0 interface{}) (*Rows, error)
	arg0     interface{}
	ret0     *Rows
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedFind) WillExecute(cb func(ctx context.Context, arg0 interface{}) (*Rows, error)) *ExpectedFind {
	e.callback = cb
	return e
}
...
type ExpectedGetIndexes struct {
	commonExpectation
	callback func(ctx context.Context) ([]driver.Index, error)
	ret0     []driver.Index
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedLocalDocs) WillExecute(cb func(ctx context.Context, options map[string]interface{}) (*Rows, error)) *ExpectedLocalDocs {
	e.callback = cb
	return e
}
...
type ExpectedPutAttachment struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, arg1 string, arg2 *driver.Attachment, options map[string]interface{}) (string, error)
	arg0     string
	arg1     string
...
type ExpectedQuery struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, arg1 string, options map[string]interface{}) (*Rows, error)
	arg0     string
	arg1     string
	ret0     *Rows
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedQuery) WillExecute(cb func(ctx context.Context, arg0 string, arg1 string, options map[string]interface{}) (*Rows, error)) *ExpectedQuery {
	e.callback = cb
	return e
}
