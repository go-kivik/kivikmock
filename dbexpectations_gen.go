...
type ExpectedRevsDiff struct {
	commonExpectation
	callback func(ctx context.Context, arg0 interface{}) (map[string]driver.RevDiff, error)
	arg0     interface{}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedRevsDiff) WillExecute(cb func(ctx context.Context, arg0 interface{}) (map[string]driver.RevDiff, error)) *ExpectedRevsDiff {
	e.callback = cb
	return e
}
